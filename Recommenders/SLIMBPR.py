...
# TODO: il prof come argomento passava BaseRecommender
class SLIM_BPR(object):
    ...
    def fit(self, epochs=15):
        ...
        self.W = self.S.T
        self.W = similarityMatrixTopK(self.W, k=20) #(k=500, MAP = 0.0174) (k=100, MAP=0.0201) (k=50, MAP = 0.0215) (k=20, MAP = 0.0222 ma quando submittato viene MAP= 0.01321)
